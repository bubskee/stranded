...
func (x *SubmitCommandRequest) GetRequestId() uint64 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (x *SubmitCommandRequest) GetCommand() []byte {
	if x != nil {
		return x.Command
	}
	return nil
...
func (x *SubmitCommandResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SubmitCommandResponse) GetLeaderHint() string {
	if x != nil {
		return x.LeaderHint
	}
	return ""
...
func (x *SubmitCommandResponse) GetResult() []byte {
	if x != nil {
		return x.Result
	}
	return nil
...
const file_raft_v1_raft_proto_rawDesc = "" +
	"\n" +
	"\x12raft/v1/raft.proto\x12\araft.v1\"N\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\x14SubmitCommandRequest\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12\x1d\n" +
	"\n" +
	"request_id\x18\x02 \x01(\x04R\trequestId\x12\x18\n" +
	"\acommand\x18\x03 \x01(\fR\acommand\"j\n" +
	"\x15SubmitCommandResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x1f\n" +
	"\vleader_hint\x18\x02 \x01(\tR\n" +
	"leaderHint\x12\x16\n" +
	"\x06result\x18\x03 \x01(\fR\x06result2\xf7\x01\n" +
	"\vRaftService\x12H\n" +
	"\vRequestVote\x12\x1b.raft.v1.RequestVoteRequest\x1a\x1c.raft.v1.RequestVoteResponse\x12N\n" +
	"\rAppendEntries\x12\x1d.raft.v1.AppendEntriesRequest\x1a\x1e.raft.v1.AppendEntriesResponse\x12N\n" +
	"\rSubmitCommand\x12\x1d.raft.v1.SubmitCommandRequest\x1a\x1e.raft.v1.SubmitCommandResponseB*Z(github.com/bubskee/stranded/proto/raftpbb\x06proto3"
...
var file_raft_v1_raft_proto_goTypes = []any{
	...
	(*SubmitCommandRequest)(nil),  // 5: raft.v1.SubmitCommandRequest
	(*SubmitCommandResponse)(nil), // 6: raft.v1.SubmitCommandResponse
}
var file_raft_v1_raft_proto_depIdxs = []int32{
	0, // 0: raft.v1.AppendEntriesRequest.entries:type_name -> raft.v1.LogEntry
	1, // 1: raft.v1.RaftService.RequestVote:input_type -> raft.v1.RequestVoteRequest
	3, // 2: raft.v1.RaftService.AppendEntries:input_type -> raft.v1.AppendEntriesRequest
	5, // 3: raft.v1.RaftService.SubmitCommand:input_type -> raft.v1.SubmitCommandRequest
	2, // 4: raft.v1.RaftService.RequestVote:output_type -> raft.v1.RequestVoteResponse
	4, // 5: raft.v1.RaftService.AppendEntries:output_type -> raft.v1.AppendEntriesResponse
	6, // 6: raft.v1.RaftService.SubmitCommand:output_type -> raft.v1.SubmitCommandResponse
